...
this["Elefund"]["templates"]["portfolio-details"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "          <li>\n            <a href=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"careers") || (depth0 != null ? lookupProperty(depth0,"careers") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"careers","hash":{},"data":data,"loc":{"start":{"line":33,"column":21},"end":{"line":33,"column":34}}}) : helper)))
  ...
  return "<div class=\"modal-backdrop\"></div>\n<div class=\"modal-container\">\n  <div class=\"modal-body\">\n    <button type=\"button\" class=\"modal-close icomoon icon-close\"></button>\n\n    <div class=\"company-head\">\n      <div class=\"company-logo brand-"
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"url") || (depth0 != null ? lookupProperty(depth0,"url") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"url","hash":{},"data":data,"loc":{"start":{"line":24,"column":19},"end":{"line":24,"column":28}}}) : helper)))
    + "\" target=\"_blank\">"
    + alias4((lookupProperty(helpers,"capitalize")||(depth0 && lookupProperty(depth0,"capitalize"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"hostname") : depth0),{"name":"capitalize","hash":{},"data":data,"loc":{"start":{"line":24,"column":46},"end":{"line":24,"column":71}}}))
    + " <i class=\"icomoon icon-arrow-right\"></i></a>\n        </li>\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"crunchbase_url") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":26,"column":8},"end":{"line":30,"column":15}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"careers") : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":31,"column":8},"end":{"line":35,"column":15}}})) != null ? stack1 : "")
    + "      </ul>\n      \n    </div>\n\n  </div>\n</div>\n";
},"useData":true});
